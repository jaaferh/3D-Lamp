public final class CubeBooth {
  ...
  // anticlockwise/counterclockwise ordering
   ...
   public static final float[] vertices = new float[] {  // x,y,z, nx,ny,nz, s,t
      -0.5f, -0.5f, -0.5f,  -1, 0, 0,  0.74f, 0.0f,  // 0
      -0.5f, -0.5f,  0.5f,  -1, 0, 0,  1.0f, 0.0f,  // 1
      -0.5f,  0.5f, -0.5f,  -1, 0, 0,  0.74f, 1.0f,  // 2
      ...
      -0.5f, -0.5f, -0.5f,  0,0,-1,  0.74f, 0.0f,  // 8
      -0.5f, -0.5f,  0.5f,  0,0,1,   0.74f, 0.0f,  // 9
      -0.5f,  0.5f, -0.5f,  0,0,-1,  0.74f, 1.0f,  // 10
      -0.5f,  0.5f,  0.5f,  0,0,1,   0.74f, 1.0f,  // 11
       0.5f, -0.5f, -0.5f,  0,0,-1,  1.0f, 0.0f,  // 12
       0.5f, -0.5f,  0.5f,  0,0,1,   1.0f, 0.0f,  // 13
       0.5f,  0.5f, -0.5f,  0,0,-1,  1.0f, 1.0f,  // 14
       0.5f,  0.5f,  0.5f,  0,0,1,   1.0f, 1.0f,  // 15

      -0.5f, -0.5f, -0.5f,  0,-1,0,  0.0f, 0.0f,  // 16
      -0.5f, -0.5f,  0.5f,  0,-1,0,  0.0f, 1.0f,  // 17
      -0.5f,  0.5f, -0.5f,  0,1,0,   0.74f, 1.0f,  // 18
      -0.5f,  0.5f,  0.5f,  0,1,0,   0.74f, 0.0f,  // 19
