public final class CubeTableLeg {
  ...
  // anticlockwise/counterclockwise ordering
   ...
   public static final float[] vertices = new float[] {  // x,y,z, nx,ny,nz, s,t
      ...
      -0.5f, -0.5f,  0.5f,  -1, 0, 0,  0.10f, 0.0f,  // 1
      -0.5f,  0.5f, -0.5f,  -1, 0, 0,  0.0f, 1.0f,  // 2
      -0.5f,  0.5f,  0.5f,  -1, 0, 0,  0.10f, 1.0f,  // 3
       0.5f, -0.5f, -0.5f,   1, 0, 0,  0.0f, 0.0f,  // 4
       0.5f, -0.5f,  0.5f,   1, 0, 0,  0.10f, 0.0f,  // 5
       0.5f,  0.5f, -0.5f,   1, 0, 0,  0.0f, 1.0f,  // 6
       0.5f,  0.5f,  0.5f,   1, 0, 0,  0.10f, 1.0f,  // 7

      -0.5f, -0.5f, -0.5f,  0,0,-1,  0.0f, 0.0f,  // 8
      -0.5f, -0.5f,  0.5f,  0,0,1,   0.0f, 0.0f,  // 9
      -0.5f,  0.5f, -0.5f,  0,0,-1,  0.0f, 1.0f,  // 10
      -0.5f,  0.5f,  0.5f,  0,0,1,   0.0f, 1.0f,  // 11
       0.5f, -0.5f, -0.5f,  0,0,-1,  0.10f, 0.0f,  // 12
       0.5f, -0.5f,  0.5f,  0,0,1,   0.15f, 0.0f,  // 13
       0.5f,  0.5f, -0.5f,  0,0,-1,  0.15f, 1.0f,  // 14
       0.5f,  0.5f,  0.5f,  0,0,1,   0.15f, 1.0f,  // 15
      ...
      -0.5f,  0.5f,  0.5f,  0,1,0,   0.0f, 0.0f,  // 19
       ...
       0.5f,  0.5f, -0.5f,  0,1,0,   0.0f, 1.0f,  // 22
