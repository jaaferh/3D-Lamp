...
public class M02_GLEventListener implements GLEventListener {
  ...
  private void initialise(GL3 gl) {
    ...
    NameNode thirdBranch = new NameNode("third branch");
    m = Mat4Transform.scale(1.4f,1.4f,1.4f);
    m = Mat4.multiply(m, Mat4Transform.translate(0,0.5f,0));
    TransformNode thirdBranchTransform = new TransformNode("scale(1.4f,1.4f,1.4f);translate(0,0.5,0)", m);
    TransformNode translateThirdToTop = new TransformNode("translate(0,4,0)",Mat4Transform.translate(0,4,0));
    ModelNode thirdBranchShape = new ModelNode("Cube(2)", cube);
    ...
    twoBranchRoot.addChild(lowerBranch);
      ...
      lowerBranch.addChild(translateToTop);
        ...
        upperBranch.addChild(translateThirdToTop);
          translateThirdToTop.addChild(thirdBranch);
          thirdBranch.addChild(thirdBranchTransform);
            thirdBranchTransform.addChild(thirdBranchShape);
